...
.config(function($stateProvider, $urlRouterProvider) {
		 ...
		 */
			 ...
			 */
				...
				url: '/:conferenceID/speakers/:speakerID',
				views: {
					'header': {
						templateUrl: 'templates/main/home/navbar.html',
						controller: 'HeaderCtrl'
					...
					'main-home': {
						templateUrl: 'templates/main/home-speakers/speaker-bio.html',
			...
			.state('main.conference', {
				...
				url: '/:conferenceID/map',
						...
						controller: 'HeaderCtrl'
                                        ...
                                        'main-home': {        
                                                templateUrl: 'templates/main/map/map.html', 
                                                controller: 'MapCtrl'
                                        },
                                        'footer': {
						templateUrl: 'templates/main/home/footer.html'
