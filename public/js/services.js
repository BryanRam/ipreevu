		...
		var AttendeeService = (function() {
			...
			function AttendeeService() {
				...
				this.Token = $localStorage.user_token;
                        ...
                        AttendeeService.prototype.CheckIfLoggedIn = function(){
                            if($localStorage.user_data == null || typeof($localStorage.user_data) == 'undefined')
                                ...
                                return AttendeeService.prototype.IsLogged(this.User, this.Token);
                        };
			 ...
			 * @returns {boolean}
			 */
			AttendeeService.prototype.IsLogged = function(user, token) {
